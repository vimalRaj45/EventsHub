...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.event-card, .feature-card');
...
// Event Registration Modal (placeholder functionality)
function registerForEvent(eventName) {
    alert(`Registration for "${eventName}" will be implemented with a proper form and backend integration.`);
}
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    registerButtons.forEach(button => {
        if (button.textContent.includes('Register') || button.textContent.includes('Join')) {
